 ...
 */
function isRouteHandler(value: any): value is IRouteHandler<Request, any> {
 ...
 */
function isProtocolHandlers(value: any): boolean {
...
function wrapHandlerContextWithParams(handler: IRouteHandler<Request, any>, params: Record<string, string>): IRouteHandler<Request, any> {
...
function wrapProtocolHandlersWithParams(handlers: Record<string, IRouteHandler<Request, any>>, params: Record<string, string>) {
  if (Object.keys(params).length === 0) {
    return handlers;
  }
